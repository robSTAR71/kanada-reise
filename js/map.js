...
const ROUTE = [
  ...
  {
    day: 12, label: "Middleton, NS", dates: "12.–13. August",
    lat: 44.947, lon: -65.073, nights: 1,
    icon: "🌿", color: "#2e7d32",
    note: "Edelweiss · Annapolis Valley",
    type: "stop",
  },
  {
    day: 13, label: "Molega Lake, NS", dates: "13.–15. August",
    lat: 44.407, lon: -64.788, nights: 2,
    icon: "🏞️", color: "#00695c",
    note: "2 Nächte am See",
    type: "stop",
  },
  {
    day: 15, label: "Halifax, NS", dates: "15.–17. August",
    lat: 44.649, lon: -63.575, nights: 2,
    icon: "🎸", color: "#512e5f",
